(() => {
    ...
    function initSliders() {
        if (document.querySelector(".ready__slider")) new core(".ready__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
            ...
            speed: 800,
            navigation: {
                prevEl: ".button-ready-prev",
                nextEl: ".button-ready-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
    ...
    function digitsCounter() {
        ...
        function digitsCountersAnimate(digitsCounter) {
            ...
            const symbol = digitsCounter.dataset.digitsCounterSymbol || "";
            const step = timestamp => {
                if (!startTimestamp) startTimestamp = timestamp;
                const progress = Math.min((timestamp - startTimestamp) / duration, 1);
                const value = digitsCounter.innerHTML = Math.floor(progress * (startPosition + startValue));
                digitsCounter.innerHTML = `${value}${symbol}`;
